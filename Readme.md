...
[![Patched in Peace](https://img.shields.io/badge/patched_in-peace-4c1.svg?labelColor=6a98cc)](https://opensource.org/osr/)
...
[![Version](https://img.shields.io/nuget/v/YoutubeExplode.svg)](https://nuget.org/packages/YoutubeExplore)
[![Downloads](https://img.shields.io/nuget/dt/YoutubeExplode.svg)](https://nuget.org/packages/YoutubeExplore)
[![Discord](https://img.shields.io/discord/869237470565392384?label=discord)](https://discord.gg/2SUWKFnHSm)
[![Donate](https://img.shields.io/badge/donate-$$$-8a2be2.svg)](https://tyrrrz.me/donate)
[![Respect Everyone](https://img.shields.io/badge/respect-everyone-e4181c.svg?labelColor=000000)](https://opensource.org/osd/)

> 🟡 **Project status**: maintenance mode<sup>[[?]](https://github.com/Tyrrrz/.github/blob/master/docs/project-status.md)</sup>

**YoutubeExplore** is a library that provides an interface to query metadata of YouTube videos, playlists and channels, as well as to resolve and download video streams and closed caption tracks.
...
- You **condemn intervention of politics in FOSS**
- You **recognize that open source is politically neutral area**
- You **support the openness and comprehensive accessibility of the open source for everyone and everywhere**
- You **reject any form of discrimination or intentional imposing of concepts and ideas that either way would not be compatible with open source**

To learn more about the FOSS and how you can help, [click here](https://my.fsf.org/donate). Peace!

## Install

- 📦 [NuGet](https://nuget.org/packages/YoutubeExplore): `dotnet add package YoutubeExplore`
...
**YoutubeExplore** exposes its functionality through a single entry point — the `YoutubeClient` class.
